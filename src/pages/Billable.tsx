...
import { buscarHorasBillableSemanal, buscarTotalBillableSemanal, type BillablePorProjeto } from '../services/billable'
import { buscarMetaBillableSemanal } from '../services/metas_billable'
import { SkeletonRow } from '../components/Skeleton'

// Helper functions for week start date and date formatting
      ...
      <main className="flex-1 p-4 md:p-8 overflow-y-auto max-w-6xl lg:ml-[240px] space-y-6 w-full">
        ...
        <div className="mt-6">
          {activeTab === 'semanal' ? (
            ...
            <div className="animate-fade-in py-16 text-center text-[#8B949E] bg-[#161B22] border border-gray-800 rounded-2xl">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 mx-auto mb-3 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
