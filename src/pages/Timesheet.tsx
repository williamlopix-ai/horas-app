...
export default function Timesheet() {
  ...
  return (
    <div className="min-h-screen bg-surface-0 text-ink-900 flex flex-col lg:flex-row">
      ...
      {/* Conteúdo Principal */}
      <main className={`flex-1 p-4 md:p-8 overflow-y-auto ${recolhida ? 'max-w-none lg:ml-16' : 'max-w-6xl lg:ml-[240px]'} transition-all duration-d3 ease-ez space-y-6 w-full`}>
