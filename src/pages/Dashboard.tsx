  ...
  return (
    <div className="min-h-screen bg-[#0B0E14] text-white p-8">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {/* Navbar */}
        <div className="flex justify-between items-center bg-[#161B22] p-6 rounded-sheet border border-gray-800">
          <div className="flex items-center gap-md">
            <div className="p-2 rounded-card bg-[#03A9F4]/10 text-[#03A9F4]">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-icon-lg h-icon-lg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        {/* Content Area */}
        <div className="bg-[#161B22] p-8 rounded-sheet border border-gray-800 space-y-4">
          ...
          <div className="p-4 bg-[#0B0E14] border border-gray-800 rounded-card">
            <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider block mb-1">Status da Sessão</span>
            <div className="flex items-center gap-sm text-sm text-[#03A9F4]">
