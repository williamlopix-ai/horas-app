...
export default function ModalProjeto({ isOpen, onClose, onSave, projeto, focarSubcategorias }: ModalProjetoProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/75 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div 
        className="bg-[#161B22] border border-gray-800 rounded-2xl w-full max-w-md p-6 relative shadow-2xl animate-in fade-in zoom-in duration-200 flex flex-col max-h-[90vh]"
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
          ...
          {/* Botões */}
          <div className="flex gap-3 pt-2 border-t border-gray-800/60 shrink-0">
            <button
              type="button"
              onClick={onClose}
